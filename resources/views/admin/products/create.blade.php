...
@section('content')
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="{{url('my_admin/products/')}}">Products </a> <a
                    href="#"
                                    ...
                                    @foreach(config('lang') as $lang)
                                        ...
                                        <div role="tabpanel" class="tab-pane @if($loop->first) active @endif"
                                            ...
                                            <div class="control-group">
                                                <label for="about_us_title_{{$lang['code']}}" class="control-label">Վերնագիր</label>
                                                <div class="controls">
                                            ...
                                            <div class="control-group">
                                                <label for="about_us_title_{{$lang['code']}}" class="control-label">Ենթավերնագիր</label>
                                                <div class="controls">
                                        ...
                                        <input type="hidden" name="translate" value="{{config('type.products')}}">
                                    @endforeach

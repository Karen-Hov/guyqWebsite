...
@section('content')
    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="{{url('my_admin/pricing/')}}">Pricing </a> <a
                    href="#"
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="{{route('pricing.store')}}"
...
{{--                                                </script>--}}
                                    ...
                                    @endforeach
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">Գին</label>
                                            <div class="controls">
